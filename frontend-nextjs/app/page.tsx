      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            {[
              { query: "Show all customers from France", time: "2 minutes ago" },
              { query: "What are the top 5 products by sales?", time: "15 minutes ago" },
              { query: "List all orders from last month", time: "1 hour ago" },
            ].map((item, i) => (
              <div key={i} className="flex items-center justify-between rounded-lg border border-border p-3 hover:bg-accent/50 transition-colors">
                <div>
